<html style="font-size: 16px;" lang="ru"><head>
  ...
  <?php include 'header.php'; ?>
    ...
    <div class="u-clearfix u-sheet">
        ...
        $id = $_GET['id'];
        $sql = "SELECT `ID_Items`, `Name_of_product`, `Manufacturer`, `Category`, `Amount`, `Sex`, `Size_RUS`, `Number_of_liters`, `Length_CM`, `Cost_per_piece`, `Availability` FROM `Items` WHERE Category = 5";
        $tovar = $db->Select($sql);
