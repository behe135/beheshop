<html style="font-size: 16px;" lang="ru"><head>
    <meta charset="utf-8">
    <title>BEHE-SHOP | Работа с курьерами</title>
...
if($tt!=null){
  ...
  echo "<script>window.location.href = './index.php';</script>";
        ...
        <h2 class="u-text u-text-default u-text-1">Работа с курьерами</h2><!--products--><!--products_options_json--><!--{"type":"Recent","source":"","tags":"","count":""}--><!--/products_options_json-->
        <a href='newcour.php' class='u-active-palette-2-light-3 u-border-none u-btn u-btn-submit u-button-style u-hover-palette-2-light-1 u-palette-4-base u-text-active-palette-2-base u-text-body-alt-color-red u-text-hover-palette-2-base u-block-6023-16'>Добавить нового курьера</a>
...
<h5 class='card-title pricing-card-title'>Номер курьера: <small class='text-muted'>".$workers[$i]['ID_Couriers']."</small></h1>
...
<a href='redcour.php?id=".$workers[$i]['ID_Couriers']."' class='u-active-palette-2-light-3 u-border-none u-btn u-btn-submit u-button-style u-hover-palette-2-light-1 u-palette-4-base u-text-active-palette-2-base u-text-body-alt-color-red u-text-hover-palette-2-base u-block-6023-16'>Редактировать</a>
<a href='delcour.php?id=".$workers[$i]['ID_Couriers']."' class='u-active-palette-2-light-3 u-border-none u-btn u-btn-submit u-button-style u-hover-palette-2-light-1 u-palette-4-base u-text-active-palette-2-base u-text-body-alt-color-red u-text-hover-palette-2-base u-block-6023-16'>Удалить</a>
</div>
