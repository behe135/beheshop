  ...
  <?php include 'header2.php'; ?>
    ...
    <section class="" id="sec-3103">
      <div class="u-clearfix u-sheet u-valign-middle u-block-6023-2">
        <div class="u-clearfix u-sheet u-valign-middle u-block-6023-2">
                <div class='u-align-center u-container-style u-group u-shape-rectangle u-block-6023-3'>
                    <div class='u-container-layout u-valign-bottom u-block-6023-4'>
                            <div class='u-container-layout u-valign-bottom u-block-6023-4'><h2 class='u-text u-text-body-alt-color-black u-text-default u-block-6023-5'>Информация о менеджере</h2><div class='u-form u-login-control u-block-6023-6'>
        ...
        $manag_id = $_SESSION["manag_id"];
        $sql = "SELECT `ID_Manager`, `Last_name`, `First_name`, `Patronymic`, `Phone_number`, `Email`, `Password` FROM `Managers` WHERE $manag_id = ID_Manager";
        $info = $db->Select($sql);
        //echo $info;
