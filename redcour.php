<html style='font-size: 16px;' lang="ru"><head>
    <meta charset="utf-8">
    <title>BEHE-SHOP | Редактирование курьера</title>
  ...
  echo "<script>window.location.href = './index.php';</script>";
          ...
          <div class='u-align-center u-container-style u-group u-shape-rectangle u-block-6023-3'> 
            <div class='u-container-layout u-valign-bottom u-block-6023-4'>
              <h2 class=''>Редактирование данных курьера</h2>
                <?php 
                  ...
                  $id = $_GET['id'];
                  $sql = "SELECT `ID_Couriers`, `Last_name`, `First_name`, `Patronymic`, `Phone_number`, `Email`, `Password` FROM `Couriers` WHERE ID_Couriers = $id";
                  ...
                  echo "
                  <form action='./redcour2.php?id=$id' method='POST' class='u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form' source='custom' name='form' style='padding: 0px;' data-services=''>
