<html style="font-size: 16px;" lang="ru"><head>
    <meta charset="utf-8">
    <title>BEHE-SHOP | Добавление курьера</title>
...
if($tt!=null){
  ...
  echo "<script>window.location.href = './index.php';</script>";
        ...
        <h2 class="">Добавление нового курьера</h2><!--products--><!--products_options_json--><!--{"type":"Recent","source":"","tags":"","count":""}--><!--/products_options_json-->
    ...
    <form action="regnewcour.php" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" data-services="">
